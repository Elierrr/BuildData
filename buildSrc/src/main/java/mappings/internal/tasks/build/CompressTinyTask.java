...
public class CompressTinyTask extends DefaultMappingsTask {
    ...
    public CompressTinyTask() {
        ...
        dependsOn(TinyJarTask.TASK_NAME, BuildMappingsTinyTask.TASK_NAME);
    ...
    public void compressTiny() throws IOException {
        ...
        FileInputStream fileInputStream = new FileInputStream(this.getTaskByType(BuildMappingsTinyTask.class).getOutputMappings());
